...
- **Freestanding** — no posts in ground, no ledger, no house connection
- **Eurotec ECO M/L pedestals** (~55–65 total) sitting on flat stone or compacted gravel
- Joists sit **directly on pedestals** — no beam underneath
...
- **[Build Guide](build_guide.html)** — Full construction guide with team roles, stain process, and build sequence
- **[Framing Plan](framing_plan.html)** — Cut list, joist layout, blocking plan, and decking math
- **[Quick Reference](quick_reference.html)** — One-page printable with all specs, materials, and timeline
- **[Stake & String Layout](stake_string.html)** — Site layout guide for the 22'×12' frame
- **[Index](index.html)** — PWA-ready landing page linking all guides
...
Personal project. Not for commercial use without permission.
