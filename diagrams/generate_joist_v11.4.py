#!/usr/bin/env python3
"""Generate joist_layout_v11.4.png — Corrected: joists run FRONT-TO-BACK (vertical)."""
...
SCALE = 28
W_FT, D_FT = 22, 12
MARGIN = {"top": 110, "bottom": 75, "left": 90, "right": 75}
...
# Draw joists FRONT-TO-BACK (vertical bars in plan view)
...
# Joist span label (front-to-back)
...
# Title
title = "Joist Layout — v11.4"
sub = "One Frame 22'×12'  ·  Joists run Front→Back (vertical)  ·  Doubled 2×6 Rims"
d.text((CW//2, 25), title, fill=TEXT, font=font_xl, anchor="mm")
d.text((CW//2, 52), sub, fill=RIM, font=font_md, anchor="mm")

# Legend
legend_y = CH - 55
legend_items = [(RIM, "Doubled 2×6 Rim (3\" thick)"), (JOIST, "2×6 Joist (1.5\" × 11'6\", front-to-back)")]
legend_x = ox
...
# Callout
callout = "~{} joists at 16\" O.C. across 22' width  ·  No cuts needed".format(len(joist_x_positions))
...
img.save("joist_layout_v11.4.png", "PNG")
print("Saved joist_layout_v11.4.png")
